...
void localTimeAndDate(void);
void currentPath(void);
void systemMsg(void);
void getAndPrintFile(char *fileName);
            ...
            if(strcmp(tokenContainer[0], options[i]) == 0)
            {
                switch(i)
                {
                    ...
                    case 4:
                        ...
                        exit(1);
                    case 5:
                        getAndPrintFile(tokenContainer[1]);
                        break;
...
void put(char **tokenContainer, int expressionSize) {
    ...
    {
        // no -f - returns error (creates dir and file)
...
void getAndPrintFile(char *fileName)
{
    ...
    fp = fopen("/Users/petar/UNI_FOLDER/T2_22/DistSys/milestone1/macros.h", "r");
